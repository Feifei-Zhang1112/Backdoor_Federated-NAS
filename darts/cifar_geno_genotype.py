...
NO_ATTACK = genotype = Genotype(normal=[('sep_conv_3x3', 1), ('eca_7', 0), ('eca_7', 2), ('eca_3', 1), ('eca_3', 3),
                                        ('eca_7', 2), ('eca_3', 2), ('eca_3', 3)], normal_concat=range(2, 6),
                                reduce=[('sep_conv_3x3', 0), ('eca_7', 1), ('skip_connect', 1), ('skip_connect', 0),
                                        ('sep_conv_3x3', 0), ('skip_connect', 1), ('skip_connect', 1), ('dil_conv_3x3_2', 2)], reduce_concat=range(2, 6))

A3FL_LOW = Genotype(normal=[('sep_conv_3x3', 1), ('eca_7', 0), ('sep_conv_3x3', 2), ('eca_3', 0),
                            ('sep_conv_3x3', 3), ('eca_5', 1), ('eca_5', 1), ('sep_conv_3x3', 4)],
                    normal_concat=range(2, 6), reduce=[('sep_conv_3x3', 1), ('eca_3', 0), ('sep_conv_3x3', 2),
                                                       ('sep_conv_3x3', 1), ('sep_conv_3x3', 3), ('sep_conv_3x3', 2), ('sep_conv_3x3', 4), ('sep_conv_3x3', 3)], reduce_concat=range(2, 6))
