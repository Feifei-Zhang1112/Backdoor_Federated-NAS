class MPIMessage(object):
    ...
    MSG_ARG_KEY_GENOTYPE = "genotype"  # new added
    MSG_ARG_KEY_BATCH_IDXS = "batch_idxs"  # new added
    MSG_ARG_KEY_LOGIT = "logit"  # new added
    MSG_ARG_KEY_SYN = "syn"  # new added
    MSG_ARG_KEY_PARTICIPANTS = "participated_clients"
